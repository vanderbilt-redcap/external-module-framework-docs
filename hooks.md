...
redcap_module_todo_add($request_id, $request_from, $request_to, $todo_type, $action_url, $project_id, $comment, $todo_type_id) | TBD | Triggered when a new item is added to the Control Center's ToDo List.
