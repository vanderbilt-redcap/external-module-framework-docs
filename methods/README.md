...
`loadBootstrap`() | TBD | Outputs the HTML necessary to load Twitter Bootstrap.
`loadREDCapJS`() | TBD | Outputs the HTML necessary to load all the javascript libraries bundled with REDCap (jQuery, DataTables, SweetAlert2, etc.).
