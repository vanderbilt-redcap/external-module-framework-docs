...
getTwig() | TBD | Returns an instance of a Twig `Environment`.  You may use this to render twig templates like `$module->getTwig()->render('template_name.html.twig', ['paramName'=> 'paramValue'])`. See details on the [Twig page](../twig.md).
...
initializeTwig() | TBD | Loads Twig classes and configures a Twig `Environment` for your module.  See details on the [Twig page](../twig.md).
